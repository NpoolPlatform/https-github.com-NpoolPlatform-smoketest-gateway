...
//
//	client.Module.Query().
//		Select(module.FieldCreatedAt).
//		Scan(ctx, &v)
//
func (mq *ModuleQuery) Select(fields ...string) *ModuleSelect {
	mq.fields = append(mq.fields, fields...)
	selbuild := &ModuleSelect{ModuleQuery: mq}
	selbuild.label = module.Label
...
func (mq *ModuleQuery) prepareQuery(ctx context.Context) error {
	...
	if module.Policy == nil {
		return errors.New("ent: uninitialized module.Policy (forgotten import ent/runtime?)")
	}
	if err := module.Policy.EvalQuery(ctx, mq); err != nil {
		return err
	}
	return nil
}
